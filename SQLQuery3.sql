...
insert into Areas(area,zipcode) values('ABCc','12345')
...
update EmployeeSkills set skill_level=8 where employee_id=101 and skill_name='c'

--update the age of employee Bimu to 29
update Employees set age=29 where employee_id=102 and name='Bimu'
